...
import pricingPackagesRoutes from './src/routes/pricingPackages.js';
import pricingTiersRoutes from './src/routes/pricingTiers.js';
...
app.use('/api/pricing-packages', pricingPackagesRoutes);
